...
test('R18M.C5 debug facade preserves the public API shape without owning gameplay execution', () => {
  ...
  assert.deepEqual(Object.keys(api), [
    ...
    'latestFinePlan', 'latestFineTracking', 'latestGuardCoverage', 'latestSwingRelevance', 'latestCloseRangePosture', 'latestHiltClang', 'latestGuardFacingPlan', 'defenderFacingYawRadians', 'latestGuardResidual', 'latestGuardStanceReach', 'latestParryWhiff',

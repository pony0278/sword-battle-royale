...
test('historical G4.3B.5R.2.7 stays covered while R18I5 guarantees TOP/RIGHT deflect release', () => {
  ...
  assert.match(html, /latched DEFLECT_IMPULSE \+ TOP\/RIGHT 7\/7, or confirmed-Parry fail-safe, starts a 28ms continuity bridge.*the weapon arm joins the running OLD B3/);
